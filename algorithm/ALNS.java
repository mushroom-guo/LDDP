...
public class ALNS {
    ...
    public double reactionFactor = 0.2; // 反应因子，控制权重调整速度
    ...
    public void Solve(Data data) throws Exception{
        ...
        while (currentTem > minTem)
        {
            for (int i = 0; i < maxIterations; i++)
            {
                ...
                // 同时增加全局计数
//                globalDestroyCount[destroyOperatorIndex]++;
//                globalRepairCount[repairOperatorIndex]++;
            ...
            System.out.println("Obj: " + currentObjVal);
            //System.out.println();
        }
        //ALNS求得的解
        //printSol(candidateSol,bestObjVal);
       printSol(bestSol, bestObjVal);

//        double alnsOnlyObjVal = heuristic.objVal(bestSol);
//        System.out.println("ALNS: " + alnsOnlyObjVal);

        //输出算子使用统计
//        System.out.println("\n============== Operator Statistics ==============");
//
//        String[] destroyNames = {"Random Destroy", "Time Window Destroy", "Similar Destroy"};
//        System.out.println("--- Destroy Operators Usage ---");
//        for (int i = 0; i < globalDestroyCount.length; i++) {
//            // 防止数组越界，如果有更多算子可以通用打印
//            String name = (i < destroyNames.length) ? destroyNames[i] : "Destroy Operator " + i;
//            System.out.println(name + ": " + globalDestroyCount[i]);
//        }
//
//        String[] repairNames = {"Random Repair", "Greedy Repair", "Regret Repair"};
//        System.out.println("\n--- Repair Operators Usage ---");
//        for (int i = 0; i < globalRepairCount.length; i++) {
//            String name = (i < repairNames.length) ? repairNames[i] : "Repair Operator " + i;
